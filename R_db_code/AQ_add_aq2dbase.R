...
#                                                       #
#   Last Update: 03/17/2017 by Wyat Appel               #
#   Removed very slow loop that determined month and 	#
#   replaced it with a much faster method		#
#                                                       #
...
check_missing    <- Sys.getenv('check_missing')
...
if ((check_missing == 'Y') || (check_missing == 'T')) {	# Skip checking for missing POCode column if set to F
   print("Checking for missing POCode column in project table...")
