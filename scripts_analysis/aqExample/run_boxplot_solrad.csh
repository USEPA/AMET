...
# -----------------------------------------------------------------------
  ...
  setenv AMET_AQSPECIES Solar_Rad
...
#  setenv AMET_NAMN y
  ...
  setenv AMET_LOG boxplot_solrad.log
...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/input_files/boxplot_solrad.input  
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Boxplot_Hourly_SolRad.R $AMET_LOG 
  ...
  echo
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_boxplot_solrad.$AMET_PTYPE
		echo "-----------------------------------------------------------------------------------------"
		exit(0)
  else
