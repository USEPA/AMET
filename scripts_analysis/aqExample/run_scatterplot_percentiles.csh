...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/nput_files/scatterplot_percentiles.input  
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots -----------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_SITE_${AMET_PID}_scatterplot_percentiles.$AMET_PTYPE"
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
