...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/input_files/histogram.input  
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "Text  -----------------------> $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_${AMET_PID}_histogram.csv"
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
