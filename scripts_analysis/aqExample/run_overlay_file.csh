...
#  setenv AMET_NAMN y
  ...
  setenv AMET_LOG overlay_file.log
...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/input_files/overlay_file.input  
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R_analysis_code/AQ_Overlay_File.R $AMET_LOG 
  ...
  echo
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "File   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_overlay.ncf
		echo "-----------------------------------------------------------------------------------------"
		exit(0)
  else
