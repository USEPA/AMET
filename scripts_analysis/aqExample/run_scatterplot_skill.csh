...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/scatterplot_skill.input  
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R/AQ_Scatterplot_skill.R $AMET_LOG
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots -- --------------------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_skill_scatterplot.$AMET_PTYPE
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
