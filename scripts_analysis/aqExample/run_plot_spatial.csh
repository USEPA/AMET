...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/plot_spatial.input  
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R/AQ_Plot_Spatial.R $AMET_LOG
