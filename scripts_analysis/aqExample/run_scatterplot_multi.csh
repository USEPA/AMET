...
# -----------------------------------------------------------------------
  ...
  #  AMET project id or simulation id (add additional project in input file)
...
##--------------------------------------------------------------------------##
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/scatterplot_multi.input  
  ...
  R CMD BATCH --no-save --slave $AMETBASE/R/AQ_Scatterplot_multi.R $AMET_LOG
  ...
  if($AMET_R_STATUS == 0) then
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plots -- --------------------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_scatterplot_multi.$AMET_PTYPE
		echo "-----------------------------------------------------------------------------------------"
		exit 0
  else
