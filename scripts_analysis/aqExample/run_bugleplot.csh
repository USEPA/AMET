...
##--------------------------------------------------------------------------##
  ...
  echo
		...
		echo "-----------------------------------------------------------------------------------------"
		echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_bugleplot_error.$AMET_PTYPE
                echo "Plot   ---------->" $AMET_OUT/${AMET_PROJECT}_${AMET_AQSPECIES}_bugleplot_bias.$AMET_PTYPE
		echo "-----------------------------------------------------------------------------------------"
		exit(0)
  else
