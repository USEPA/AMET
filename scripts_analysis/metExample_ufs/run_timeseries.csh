...
#                          USER CONFIGURATION OPTIONS
  ...
  setenv AMET_PROJECT1 metExample_ufs
  ...
  setenv AMET_YY "2018 2018"             
  setenv AMET_MM "07 07"             
  setenv AMET_DD "01 31"             

  #  Additional criteria to add to site query
  setenv AMET_EXTRA1 "AND fcast_hr BETWEEN 0 and 24"             
  setenv AMET_EXTRA2 "AND fcast_hr BETWEEN 0 and 24"             
