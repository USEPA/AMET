...
# -----------------------------------------------------------------------
# Purpose:
# Evaluation of MPAS/WRF shortwave radiation using the global BSRN 
# observations. Spatial, diurnal, timeseries and histogram plots
...
#                          USER CONFIGURATION OPTIONS
  ...
  setenv AMETRINPUT $AMETBASE/scripts_analysis/$AMET_PROJECT/input_files/plot_srad.input 
  ...
  R --no-save --slave < $AMETBASE/R_analysis_code/MET_plot_srad.R 
