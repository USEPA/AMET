...
filename[5]          <- paste(figdir,"/",filename_bias_diff,".html",sep="") 		# Filename for diff spatial plot
...
filename[6]          <- paste(figdir,"/",filename_error_diff,".html",sep="")     	# Filename for diff spatial plot
...
filename_png[5]      <- paste(figdir,"/",filename_bias_diff,".png",sep="")                # Filename for diff spatial plot
...
filename_png[6]      <- paste(figdir,"/",filename_error_diff,".png",sep="")       # Filename for diff spatial plot
