...
### a single model-to-obs density scatterplot, where higher density
### areas of the plot are shaded differently from lower density areas.
### This script will plot a single species for a single network using 
